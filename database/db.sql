...
CREATE TABLE IF NOT EXISTS SAVED_RECIPE ( recipeid INTEGER PRIMARY KEY NOT NULL, username TEXT PRIMARY KEY NOT NULL)
...
INSERT INTO SAVED_RECIPE VALUES (661340, 'subu');
